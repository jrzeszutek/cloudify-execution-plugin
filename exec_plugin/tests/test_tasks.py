...
class TestTasks(testtools.TestCase):
    ...
    def mock_ctx(self, test_name):
        ...
        test_properties = {
            'resource_config': {
                'resource_path': 'resources/test.zip',
            },
        }
    ...
    def test_execute_no_resource_config(self):
        ...
        del ctx.node.properties['resource_config']['resource_path']
        self.assertRaises(
            NonRecoverableError,
            tasks.execute,
    ...
    def test_execute_bad_archive(self):
        ctx = self.mock_ctx('test_execute_bad_archive')
